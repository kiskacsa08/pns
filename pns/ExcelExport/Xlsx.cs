...
namespace Pns.ExcelExport
{
    class ExcelDoc
    {
        ...
        {
            Worksheet ws = (Worksheet)workbook.ActiveSheet;
            return ws.get_Range(ws.Cells[row, column], ws.Cells[row + n_rows - 1, column + n_columns - 1]);
        }
        ...
        public void Save(string t_file, bool t_quit)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show(ex.ToString(), def_PnsStudio.Ex_excel_export_error, 
