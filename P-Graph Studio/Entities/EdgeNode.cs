...
namespace PNSDraw
{
    public class EdgeNode : Canvas.IGraphicsObject
    {
        ...
        public void Draw(Graphics g, bool plain)
        {
            ...
            Color c = Color.Black;
            int size = Config.Instance.EdgeNodeSize;
            if (Selected)
            {
                c = Color.Red;
            }
            if (Needed == false)
            {
                size = Config.Instance.TemporaryEdgeNodeSize;
        ...
        public void DrawGhost(System.Drawing.Graphics g)
        {
            if (Needed == true)
            {
                ...
                {
                    DrawNode(g, Color.Silver, coords + (Size)offset, Config.Instance.EdgeNodeSize);
                }
            }
        }
        ...
        public bool HitTest(Point mousecoords)
        {
            ...
            if (Math.Round(Math.Sqrt(dx * dx + dy * dy)) < Config.Instance.EdgeNodeSize)
            {
                return true;
            }
            return false;
        ...
        {
            rect.Inflate(Config.Instance.EdgeNodeSize, Config.Instance.EdgeNodeSize);
