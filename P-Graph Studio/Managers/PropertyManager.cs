...
namespace PNSDraw
{
    ...
    * */
    public class ObjectPropertySorter : ExpandableObjectConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            ...
            if (double.TryParse((string)value, System.Globalization.NumberStyles.Number, culture, out newValue))
            {
                op = oldOP;
            ...
            {
                Match m = Regex.Match((string)value, @"\d+");
                if (double.TryParse(m.Value, System.Globalization.NumberStyles.Number, culture, out newValue))
                {
                    op = oldOP;
                    op.ValueProp = newValue;
                    return op;
    ...
    public class StylePropertySorter : ExpandableObjectConverter
    {
        TextObject oldOP;
        ...
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType)
        {
            if (destinationType == typeof(TextObject))
            {
                return true;
            }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
        {
            TextObject op = (TextObject)value;
            oldOP = op;
            //return op.Text;//op.ValueProp.ToString() + " " + op.MUProp.ToString();
            return "";
        }
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            ...
            if (int.TryParse((string)value, System.Globalization.NumberStyles.Number, culture, out newValue))
            {
                op = oldOP;
                op.FontSize = newValue;
                return op;
            }
            else
            {
                Match m = Regex.Match((string)value, @"\d+");
                if (int.TryParse(m.Value, System.Globalization.NumberStyles.Number, culture, out newValue))
                {
                    op = oldOP;
                    op.FontSize = newValue;
                    return op;
