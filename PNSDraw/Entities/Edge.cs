...
namespace PNSDraw
{
    public class Edge : Canvas.IGraphicsObject
    {
        ...
        double arrowposition = 0.5F;
        bool arrowoncenter = true;
        ...
        private List<PointF> ComputeArrowPositionAndAngle(List<PointF> pointlist)
        {
            ...
            last = pointlist[0];
            double tmplength = 0;
            double arrowposition = ArrowPosition;
        ...
        {
            Pen pen = new Pen(new SolidBrush(c), Globals.LineSize * 2);
        ...
        public double ArrowPositionProp
        {
            get
            {
                return Math.Round(ArrowPosition * 100);
            }
            set
            {
                ArrowPosition = value/100;
            }
        }

        [Browsable(true)]
        [DisplayName("Arrow on center")]
        public bool ArrowOnCenterProp
        {
            get
            {
                return ArrowOnCenter;
